      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-sm">
              Ofrecemos soluciones de seguridad de alta calidad para proteger lo
              que más importa. Con Smart Shield, su seguridad es nuestra
              prioridad.
            </p>
          </div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  Av de las Américas, Av Principal #3, Machala
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-400">(+593) 969235589</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-400">felixarueda1993gmail.com</span>
              </li>
            </ul>
          </div>
          <div>
