        ...
        <div className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
              <span className="block">Advanced Security Solutions</span>
              <span className="block text-blue-500">for Home and Business</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Protect what matters most with Smart Shield's cutting-edge CCTV systems and security cameras. Professional installation and support available nationwide.
            </p>
            ...
            <div className="mx-auto text-base max-w-prose lg:max-w-none flex items-center justify-center">
              <div className="relative z-10 p-8 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-2xl shadow-xl">
                <div className="flex items-center mb-6">
                  ...
                  <span className="text-white text-2xl font-bold ml-3">Smart Shield Security</span>
                </div>
                <blockquote>
                  <p className="text-lg text-white font-medium">
                    "With Smart Shield cameras installed, I finally feel secure about my business premises even when I'm away. Their customer support is absolutely top-notch."
                  </p>
